...
const SideBar = () => {
   ...
   return (
      <>
         ...
         {/* overlAY */}
         {open && <div className="absolute top-0 left-0 w-full h-screen bg-black/50 z-40" onClick={() => setOpen(false)}></div>}
         <aside
         ...
         >
            <div className="p-6 flex items-center text-blue-800 flex-col my-5">
